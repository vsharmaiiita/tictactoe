...
ActiveRecord::Schema.define(version: 2019_06_15_103707) do
  ...
  create_table "player_boards", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci", force: :cascade do |t|
